...
func DefineAndCreateDeamonsetWithMultusOnCluster(nadName, namespace string) error {
	return defineDaemonSetBasedOnArgs(nadName, namespace, nil)
}

func DefineAndCreateDeamonsetWithMultusAndSkipLabelOnCluster(nadName, namespace string) error {
	return defineDaemonSetBasedOnArgs(nadName, namespace, tsparams.NetworkingTestMultusSkipLabel)
}
...
func defineDaemonSetBasedOnArgs(nadName, namespace string, labels map[string]string) error {
